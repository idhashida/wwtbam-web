...
export default function Field() {
    return (
        <div className='flex flex-col p-1 gap-5 h-dvh bg-primary-default rounded-md'>
            <div className='flex justify-between p-5 gap-32 b2d'>
                <Help/>
            ...
            <div className='flex h-[100%] p-5 b2d'>
                <Answers/>
            </div>
        </div>
    )
